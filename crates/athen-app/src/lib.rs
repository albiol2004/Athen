...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::set_arc_security_mode,
            ...
            commands::set_arc_goal,
            commands::get_arc_goal,
            commands::clear_arc_goal,
            commands::start_plan,
            commands::approve_plan,
            commands::update_plan_draft,
            commands::get_plan,
            commands::clear_plan,
