...
pub fn presets() -> Vec<EndpointPreset> {
    vec![
        ...
        EndpointPreset {
            ...
            default_headers: vec![h("Cartesia-Version", "2026-03-01")],
            suggested_risk: Some("read_network"),
            default_rate_limit_per_minute: 60,
